...
# Form implementation generated from reading ui file 'src/gui/black_window_test2.ui'
#
...
"color: rgb(36, 36, 36)}"))
        ...
        self.adekLogo = QtGui.QLabel(self.frame_2)
...
"border-image: none;"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.throttleBar.setFormat(_translate("MainWindow", "%v %", None))
